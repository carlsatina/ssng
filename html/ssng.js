...
var vm = new Vue({
    ...
    data: {
        ...
        el: {
            ...
            epcData: "0x80",
            epcDataList: [
                { "value":"0x80", "desc":"Operating status" },
                { "value":"0x82", "desc":"Version Information" },
                { "value":"0x83", "desc":"Identification number" },
                { "value":"0x84", "desc":"Measured Instantaneous power consumption" },
                { "value":"0x85", "desc":"Measured commulative electric energy consumption" },
                { "value":"0x86", "desc":"Manufacturer's fault code" },
                { "value":"0x87", "desc":"Current limit setting" },
                { "value":"0x88", "desc":"Fault status" },
                { "value":"0x89", "desc":"Fault description" },
                { "value":"0x8A", "desc":"Manufacturer code" },
                { "value":"0x8B", "desc":"Business facility code" },
                { "value":"0x8C", "desc":"Product code" },
                { "value":"0x8D", "desc":"Production number" },
                { "value":"0x8E", "desc":"Production date" },
                { "value":"0x8F", "desc":"Power-saving operation setting" },
                { "value":"0x93", "desc":"Remote Control setting" },
                { "value":"0x97", "desc":"Current time setting" },
                { "value":"0x98", "desc":"Current date setting" },
                { "value":"0x99", "desc":"Power limit setting" },
                { "value":"0x9A", "desc":"Cumulative operating time" },
                { "value":"0x9D", "desc":"Status change announcement property map" },
                { "value":"0x9E", "desc":"Set property map" },
                { "value":"0x9F", "desc":"Get property map" },
                { "value":"0xC1", "desc":"Monthly maximum electric power demand" },
                { "value":"0xC2", "desc":"Cumulative maximum electric power demand" },
                { "value":"0xC3", "desc":"Electric power demand at fixed time (30-min average eletric power)" },
                { "value":"0xC4", "desc":"Number of effective digits of electric power demand" },
                { "value":"0xC5", "desc":"Unit of electric power demand" },
                { "value":"0xC6", "desc":"Historical data of measured electric power demand" },
                { "value":"0xC7", "desc":"Unit of cumulative maximum electric power demand" },
                { "value":"0xCA", "desc":"Measurement data of reactive electric power consumption (lag) for power factor measurement" },
                { "value":"0xCB", "desc":"Measurement data of cumulative amount of reactive electric power consumption (lag) at fixed time for power factor measurement" },
                { "value":"0xCC", "desc":"Number of effective digits for measurement data of cumulative amount of reactive electric power consumption (lag) for power factor measurement" },
                { "value":"0xCD", "desc":"Unit of measurement data of cumulative amount of reactive electric power consumption (lag)" },
                { "value":"0xCE", "desc":"Historical data of measurement data of cumulative amount of reactive electric power consumption (lag) for power factor measurement" },
                { "value":"0xD3", "desc":"Number of self-node instances" },
                { "value":"0xD4", "desc":"Number of self-node classes" },
                { "value":"0xE0", "desc":"Fixed date" },
                { "value":"0xE1", "desc":"Day for which the historical data of measured cumulative amounts of electric energy is to be retrieved" },
                { "value":"0xE2", "desc":"Measured cumulative amounts of active electric energy" },
                { "value":"0xE3", "desc":"Cumulative amounts of active electric energy at fixed time" },
                { "value":"0xE4", "desc":"Measurement data of cumulative amounts of active electric energy for power factor measurement" },
                { "value":"0xE5", "desc":"Number of effective digits for cumulative amount of active electric energy" },
                { "value":"0xE6", "desc":"Unit of cumulative amounts of effective electric energy" },
                { "value":"0xE7", "desc":"Historical data of measured cumulative amount of active electric energy" }
            ],
            edtData: "0x30"
        },
    ...
    methods: {
        ...
        GetMeasuredIEE: function () {
            GetMeasuredIEE(this.ipData);
        },
        GetMeasuredCAofEE: function () {
            GetMeasuredCAofEE(this.ipData)
        },
        GetMeasuredICurrent: function () {
            GetMeasuredICurrent(this.ipData)
        },
...
function GetMeasuredICurrent(ipData)
{
    // Get Measured Instantaneous Current
    let uint8Array = [16, 129, 0, 1, 5, 255, 1, 2, 136, 1, 98, 1, 232, 0]
...
function GetMeasuredCAofEE(ipData)
{
    // Get Measured Cummulative Amount of Electric Energy
    let uint8Array = [16, 129, 0, 7, 5, 255, 1, 2, 136, 1, 98, 1, 224, 0]
...
function GetMeasuredIEE(ipData)
{
    // Get Measured Instantaneous Electric Energy
    let uint8Array = [16, 129, 0, 1, 5, 255, 1, 2, 136, 1, 98, 1, 231, 0];
